...
export const features: Feature[] = [
  {
    ...
    description: 'sma.features.angular',
  ...
  },
  {
    ...
    description: 'sma.features.angular-material',
  ...
  },
  {
    ...
    description: 'sma.features.angular-cli',
  ...
  },
  {
    ...
    description: 'sma.features.bootstrap',
  ...
  },
  {
    ...
    description: 'sma.features.typescript',
  ...
  },
  {
    ...
    description: 'sma.features.ngxtranslate',
  ...
  },
  {
    ...
    description: 'sma.features.fontawesome',
  ...
  },
  {
    ...
    description: 'sma.features.cypress',
    github: 'https://github.com/cypress-io/cypress',
    documentation: 'https://www.cypress.io/'
  },
  {
    name: 'sma.features.themes.title',
    description: 'sma.features.themes.description',
    documentation: 'https://material.angular.io/guide/theming',
    medium:
      'https://medium.com/@tomastrajan/the-complete-guide-to-angular-material-themes-4d165a9d24d1'
  },
  {
    name: 'sma.features.lazyloading.title',
    description: 'sma.features.lazyloading.description',
    documentation:
